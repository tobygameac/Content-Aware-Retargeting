...
namespace PatchBasedImageWarpingForContentAwareRetargeting {
  ...
  private:
    ...
    void PatchBasedImageWarpingForContentAwareRetargeting(const int target_image_width, const int target_image_height, const float grid_size);
...
#pragma region Windows Form Designer generated code
    ...
    void InitializeComponent(void) {
      ...
      this->Name = L"GLForm";
      this->Text = L"Patch-Based Image Warping for Content-Aware Retargeting";
